          ...
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-warning">
              <div class="card-header text-center">
                <h4 class="text-warning">Silahkan masuk untuk melanjutkan</h4>
              </div>
              <div class="card-body">
                <form method="POST" action="<?= base_url() ?>pesan/<?= $paket['paket_id'] ?>" class="needs-validation" novalidate="">
            ...
            <div class="mt-5 text-muted text-center">
              Don't have an account? <a href="<?= base_url() ?>daftar" target="_blank">Create One</a>
            </div>
          </div>
        </div>
      </div>
