...
class BannerController extends CI_Controller
{
	...
	{
		$data = array(
			'title' => 'Data Banner | Wedding Organizer',
	...
	public function tambah(){
		if (isset($_POST['simpan'])){
			...
			if (!$this->upload->do_upload('foto')) {
				...
				$simpan = $this->CrudModel->insert('tb_banner',$data);
				if ($simpan > 0){
			...
			$data = array(
				'title' => 'Tambah Data Banner | Wedding Organizer',
	...
	public function update($id){
		if (isset($_POST['update'])){
			...
			if (!$this->upload->do_upload('foto')) {
				...
				$update = $this->CrudModel->update('banner_id',$id,'tb_banner',$data);
				if ($update > 0){
			...
			$data = array(
				'title' => 'Update Data Banner | Wedding Organizer',
				'page_title' => 'Update Data Banner',
				'icon_title' => 'fa-picture-o',
				'banner' => $this->CrudModel->view_data_by_id($id,'banner_id','tb_banner')
			);
			$this->load->view('backend/templates/header',$data);
